...
-- =============================================
-- SUPPORT TICKET (READ/UNREAD) MODULE
-- =============================================

-- Tracks last read timestamp per viewer (raiser/admin) for each ticket.
-- Unread badge is computed as: count of replies from the *other side* after last_read_at.
